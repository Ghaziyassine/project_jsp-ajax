...
public final class marqueForm_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("                var confirmation = confirm(\"Voulez-vous vraiment supprimer cette marque ?\");\n");
      out.write("                        if (confirmation) {\n");
      out.write("                window.location.href = \"MarqueController?op=delete&id=\" + id;\n");
      out.write("                } else {\n");
      ...
      out.write("        html:\n");
      out.write("            '<input id=\"code\" class=\"swal2-input\" placeholder=\"Code\">' +\n");
      out.write("            '<input id=\"libelle\" class=\"swal2-input\" placeholder=\"Libellé\">',\n");
      out.write("        showCancelButton: true,\n");
      out.write("        confirmButtonText: 'Modifier',\n");
      out.write("        onOpen: () => {\n");
      out.write("            // Vous pouvez également ajouter un sélecteur de date ici si nécessaire\n");
      out.write("        },\n");
      out.write("        preConfirm: () => {\n");
      out.write("            const code = Swal.getPopup().querySelector('#code').value;\n");
      out.write("            const libelle = Swal.getPopup().querySelector('#libelle').value;\n");
      out.write("\n");
      out.write("            if (!code || !libelle) {\n");
      out.write("                Swal.showValidationMessage('Veuillez remplir tous les champs.');\n");
      out.write("            }\n");
      out.write("\n");
      out.write("            return { code, libelle };\n");
      out.write("        }\n");
      out.write("    }).then((result) => {\n");
      out.write("        if (!result.dismiss) {\n");
      out.write("            const { code, libelle } = result.value;\n");
      out.write("            // Construisez l'URL avec les données\n");
      out.write("            const url = \"MarqueController?op=update&id=\" + id +\n");
      out.write("                \"&code=\" + code + \"&libelle=\" + libelle;\n");
      out.write("\n");
